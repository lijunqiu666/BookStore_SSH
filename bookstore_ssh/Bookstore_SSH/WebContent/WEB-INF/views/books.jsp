		...
		<div class="row">
			<c:forEach items="${page.list }" var="book">
				<div class="col-sm-6 col-md-3">
					<div class="thumbnail">
						<img class="img-rounded" src="/file2/${book.imgpath}" alt="${book.title}"
							class="img-thumbnail">
						<div class="caption">
							<h4>
								<a class="booktitle" title="查看${book.title }的详细信息" href="${pageContext.request.contextPath}/getbookinfo?id=${book.id}&pagenumber=${page.pageNo }">${book.title }</a>
							</h4>
							<p class="bookinfo">
