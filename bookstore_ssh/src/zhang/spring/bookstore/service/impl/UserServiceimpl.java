...
public class UserServiceimpl implements UserService{
	...
	public void doPayCash(ShoppingCart shoppingCart, User user,HttpServletRequest request) {
		...
		for(ShoppingCartItem Cartitem:items){
			...
			//交易项设置为已经付款
			orderStatus orderstatus=orderStatusDao.getStatusById(2);
			System.out.println(orderstatus.getStatuName());
			tradeItem.setOrderstatus(orderstatus);
	...
	public void getUserInfo(HttpServletRequest request) {
		//从request请求域中获取user对象,管理员查看用户信息
